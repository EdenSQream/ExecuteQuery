...
public class CloseTabbedPaneUI extends BasicTabbedPaneUI
     ...
     * which have extended CloseTabbedPaneUI to do their own layout, the
    ...
    protected void installDefaults() {
        ...
        activeColor = UIManager.getColor("TabbedPane.selected");
        if (activeColor == null) {
            activeColor = UIManager.getColor("TabbedPane.background");
            
            if (activeColor == null) { // if still null (some l&f)
                activeColor = UIManager.getColor("control");
            }
        ...
        if (unselectedBackground == null) {
            unselectedBackground = UIManager.getColor("TabbedPane.unselectedTabBackground");
            
            if (unselectedBackground == null) { // if still null (some l&f)
                unselectedBackground = UIManager.getColor("controlLightShadow");
                if (unselectedBackground == null) { // if still null - give up
                    unselectedBackground = tabPane.getBackground().darker();
                }
            }
            
        }

        // make the selected colour a little darker
        //unselectedBackground = unselectedBackground.darker();
        ...
        tabAreaInsets = new Insets(2,0,0,6);
    ...
    protected void installListeners() {
        ...
        if ((mouseListener = createMouseListener()) != null) {
            if (scrollableTabLayoutEnabled()) {
                ...
                tabScroller.tabPanel.addMouseMotionListener((MouseMotionListener)mouseListener);
            } else { // WRAP_TAB_LAYOUT
    ...
    protected MouseListener createMouseListener() {
        return handler;//new MouseHandler();
    }
    
    protected FocusListener createFocusListener() {
        return handler;//new FocusHandler();
    }
    
    protected ChangeListener createChangeListener() {
        return handler;//new TabSelectionHandler();
    }
    
    protected PropertyChangeListener createPropertyChangeListener() {
        return handler;//new PropertyChangeHandler();
    }
...
//        map.put("scrollTabsBackwardAction",new ScrollTabsBackwardAction());
    ...
    */
    ...
    protected void paintContentBorderTopEdge(Graphics g,
        ...
        if (tabPlacement == TOP) {
            ...
            g.setColor(activeColor);
            g.drawLine(rect.x+1, y, rect.x + rect.width - 2, y);
        }
    ...
    */
     ...
     * Instantiate it only within subclasses of CloseTabbedPaneUI.
     */
    ...
    private class ScrollableTabPanel extends JPanel implements UIResource {
        ...
        public void paintComponent(Graphics g) {
            ...
            CloseTabbedPaneUI.this.paintTabArea(g, tabPane.getTabPlacement(),
    ...
    public class Handler implements MouseListener, 
        ...
        public void propertyChange(PropertyChangeEvent e) {
            ...
            if ("mnemonicAt".equals(name)) {
                ...
                CloseTabbedPaneUI.this.uninstallUI(pane);
                CloseTabbedPaneUI.this.installUI(pane);
            }
        }
        ...
        public void mouseMoved(MouseEvent e) {
            ...
            for (int i = 0, k = tabPane.getTabCount(); i < k; i++) {
            ...
            if (tabPane instanceof TabPopupMenuContainer) {
            
                TabPopupMenuContainer tabPanePopupContainer = (TabPopupMenuContainer)tabPane;
                
                if (!tabPanePopupContainer.isTabPopupShowing()) {
                
                    // fire the rollover listeners
                    if (currentCloseRolloverIndex == -1 && rollOverIndex != -1) {
        
                        Point point = SwingUtilities.convertPoint(
                                        tabScroller.tabPanel, x, y, tabPane);
        
                        
                        if (tabPane instanceof SimpleCloseTabbedPane) {
                            SimpleCloseTabbedPane pane = (SimpleCloseTabbedPane)tabPane;
                            pane.fireTabRollOver(
                                    new TabRolloverEvent(pane, rollOverIndex, point.x, point.y));
                        }
                    }
                    else { // fire roll finished
                        if (tabPane instanceof SimpleCloseTabbedPane) {
                            SimpleCloseTabbedPane pane = (SimpleCloseTabbedPane)tabPane;
                            pane.fireTabRollOverFinished(new TabRolloverEvent(pane, -1));
                        }
                    }
        ...
        private boolean maybeShowPopup(MouseEvent e) {
            ...
            if (e.isPopupTrigger()) {
                ...
                fireTabRolloverCancelled(e);
                
                if (tabPane instanceof TabPopupMenuContainer) {
                    TabPopupMenuContainer tabPanePopupContainer = (TabPopupMenuContainer)tabPane;
                    if (tabPanePopupContainer.isTabPopupEnabled()) {
                        ...
                        for (int i = 0, k = tabPane.getTabCount(); i < k; i++) {
                            ...
                            if (tabRect.contains(x, y)) {
                                ...
                                tabPanePopupContainer.showPopup(i, point.x, point.y);
                                break;
                            }
                        }
        ...
        public void mouseExited(MouseEvent e) {
            ...
            if (tabPane instanceof TabPopupMenuContainer) {
                ...
                if (!tabPanePopupContainer.isTabPopupShowing()) {
                    // fire the rollover listeners
                    fireTabRolloverFinished(e);
                }
            }

        }

        private void fireTabRolloverFinished(MouseEvent e) {
            if (tabPane instanceof SimpleCloseTabbedPane) {
                SimpleCloseTabbedPane pane = (SimpleCloseTabbedPane)tabPane;
                pane.fireTabRollOverFinished(
                        new TabRolloverEvent(pane, -1, e.getX(), e.getY()));
            }
        }

        private void fireTabRolloverCancelled(MouseEvent e) {
            if (tabPane instanceof SimpleCloseTabbedPane) {
                SimpleCloseTabbedPane pane = (SimpleCloseTabbedPane)tabPane;
                pane.fireTabRollOverCancelled(
                        new TabRolloverEvent(pane, -1, e.getX(), e.getY()));
            }
        }
